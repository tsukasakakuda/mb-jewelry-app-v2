...
DATABASE_PATH = 'jewelry_calculator.db'
    ...
    try:
        ...
        for history in histories:
            ...
            """, (
                ...
                f"Migrated from old system. Original item_count: {history.get('item_count', 0)}, total_value: {history.get('total_value', 0)}",
...
if __name__ == "__main__":
    print("=" * 50)
    print("🚀 データベース一括移行スクリプト")
    print("=" * 50)
    
    # 移行実行の確認
    response = input("データベースの一括移行を実行しますか？ (yes/no): ")
